...
def test_transcriber_initialization_cpu(mock_cuda_avail: MagicMock, mock_whisper_model: MagicMock) -> None:
...
@patch("whisper_typing.transcriber.WhisperModel")
@patch("torch.cuda.is_available")
def test_transcriber_initialization_cuda_auto(mock_cuda_avail: MagicMock, mock_whisper_model: MagicMock) -> None:
